      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            {/* Regulation */}
            <div>
              <label className="text-sm dark:text-black">Regulation</label>
              <div className="flex">
                <select
            ...
            {/* Department */}
            <div>
              <label className="text-sm dark:text-black">Department</label>
              <div className="flex">
                <select
                  className="w-full p-3 border rounded-lg dark:bg-gray-800 dark:text-white"
                  value={deptId}
            ...
            {/* Semester */}
            <div>
              <label className="text-sm dark:text-black">Semester</label>
              <div className="flex">
                <select
                  className="w-full p-3 border rounded-lg dark:bg-gray-800 dark:text-white"
                  value={semesterId}
