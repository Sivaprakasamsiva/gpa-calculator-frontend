...
const AdminDashboard = () => {
  ...
  const cards = [
    ...
    { title: "Departments", value: stats.departments, icon: BookOpen, color: "bg-green-600" },
    { title: "Reports Generated", value: stats.reports, icon: FileText, color: "bg-purple-600" },
    { title: "Active Regulations", value: stats.regulations, icon: BarChart3, color: "bg-orange-500" },
  ];
