...
import SearchableElectiveSelect from "../components/SearchableElectiveSelect";
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
                <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Mandatory subjects are fixed. For each Elective row, select the elective paper and grade.
                  </p>
                </div>
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
                      {rows.map((row) => {
                        ...
                        return (
                          <tr key={row.rowId} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                              {!isElect ? (
                                ...
                                <div className="flex flex-col space-y-1">
                                  ...
                                  <SearchableElectiveSelect
  value={row.subjectId}
  options={electiveOptions}
  onChange={(val) => handleElectiveSubjectChange(row.rowId, val)}
/>
