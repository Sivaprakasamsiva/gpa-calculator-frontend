...
export const studentAPI = {
  ...
  getSubjects: (regId, deptId, semesterNumber) =>
...
export const adminAPI = {
  // Students
  getStudents: (page = 0, size = 10) => api.get("/admin/students", { params: { page, size } }),
  ...
  // Semesters (new)
  getSemesters: (regulationId, departmentId) =>
    api.get("/admin/semesters", { params: { regulationId: Number(regulationId), departmentId: Number(departmentId) } }),
  ...
  // Subjects
  // getSubjects expects regulationId, departmentId, semesterNumber (not semester id)
  getSubjects: (regulationId, departmentId, semesterNumber) =>
