...
export const studentAPI = {
  ...
  // ======================================
  // 🔥 NEW JSON APIs (Frontend PDF builder)
  // ======================================
...
export const adminAPI = {
  ...
  // ===========================
// ADMIN → USE STUDENT APIS
// ===========================
getStudentHistory: (studentId) =>
  api.get("/student/history", { params: { studentId } }),

getStudentSemesterReport: (studentId, sem) =>
  api.get("/student/semester-report", {
    params: { semester: Number(sem), studentId },
  }),

downloadStudentMarksheet: (studentId, sem) =>
  api.get(`/student/marksheet/${sem}`, {
    params: { studentId },
    responseType: "blob",
  }),
...
downloadStudentMarksheet: (studentId, semester) =>
  ...
  downloadReport: (id) =>
    api.get(`/admin/reports/${id}/download`, {
      responseType: "blob",
    }),
};
