...
export const generateGPAPDF = async ({ profile, semester, rows, gpaResult }) => {
  try {
    ...
    container.style.background = "#d3f5d1"; // Soft premium green
    ...
    container.innerHTML = `
      <h2 style="text-align:center; font-size:26px; font-weight:bold; margin-bottom:4px; color:#004d26;">
        CGPA CalC - Semester Performance Report
      </h2>
      <p style="text-align:center; font-size:13px; margin-top:0; color:#005c2d;">
        Generated Report | Verified Academic Summary
      </p>

      <hr style="border:1px solid #007a3d; margin:8px 0 12px 0;">
        ...
        <tbody>
          ${rows
            ...
            <tr style="background:${i % 2 === 0 ? "#dbf7d6" : "#c6f2c7"};">
              ...
              <td style="border:1px solid #006b34; font-weight:bold; padding:5px;">${formatGrade(r.grade)}</td>
      ...
      <div style="font-size:15px; border:2px solid #006b34; display:inline-block; padding:10px; border-radius:6px; background:#e2ffe2;">
