    ...
    <AuthContext.Provider value={{ user, login, logout, loading, setLoading }}>
      <Router>
        <Routes>
          ...
          <Route path="/register" element={!user ? <Register /> : <Navigate to="/redirect" />} />
          ...
          <Route path="/gpa" element={
            <PrivateRoute role="STUDENT"><GPACalculator /></PrivateRoute>
          }/>
          <Route path="/cgpa" element={
            <PrivateRoute role="STUDENT"><CGPACalculator /></PrivateRoute>
          }/>
          <Route path="/history" element={
            <PrivateRoute role="STUDENT"><History /></PrivateRoute>
          }/>
          ...
          <Route path="/admin/students" element={
            <PrivateRoute role="ADMIN"><StudentManagement /></PrivateRoute>
          }/>
          <Route path="/admin/curriculum" element={
            <PrivateRoute role="ADMIN"><CurriculumManagement /></PrivateRoute>
          }/>
